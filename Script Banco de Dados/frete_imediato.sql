...
--
-- Host: 127.0.0.1
-- Generation Time: 06-Dez-2016 às 04:28
...
CREATE TABLE `tb_alertalance` (
  `idAleLan` int(11) NOT NULL,
...
CREATE TABLE `tb_alertamensagem` (
  `idAleMen` int(11) NOT NULL,
...
CREATE TABLE `tb_conteudo_transporte` (
  `idConTran` int(11) NOT NULL,
...
CREATE TABLE `tb_endereco_transporte` (
  `idEndTran` int(11) NOT NULL,
...
CREATE TABLE `tb_imagens_transporte` (
  `idImgTran` int(11) NOT NULL,
...
(2, '25.250', '2016-12-05 01:05:39', 71, 16, 'A');
...
CREATE TABLE `tb_pessoa_voucher` (
  `idPesVou` int(11) NOT NULL,
...
CREATE TABLE `tb_situacaomensalidade` (
...
CREATE TABLE `tb_statustransp` (
  `idStaTransp` int(11) NOT NULL,
...
(71, '1141414', '2016-12-04 17:10:25', 4, '', 0, 1, 14, 81, '0.00', '2016-12-31 00:00:00', '00:05:00.0', ''),
...
(82, 'gggsd', '2016-12-05 23:21:54', 4, '23234234', 2, 1, 14, 92, '324.24', '2016-12-21 00:00:00', '09:15:00.0', ''),
...
--
-- Indexes for table `tb_alertalance`
--
ALTER TABLE `tb_alertalance`
  ADD PRIMARY KEY (`idAleLan`,`tb_Lance_idLan`),
  ADD KEY `fk_tb_alertaLance_tb_lance_idx` (`tb_Lance_idLan`);

--
-- Indexes for table `tb_alertamensagem`
--
ALTER TABLE `tb_alertamensagem`
  ADD PRIMARY KEY (`idAleMen`,`tb_mensagem_idMen`),
  ADD KEY `fk_tb_alertaMensagem_tb_mensagem1_idx` (`tb_mensagem_idMen`);

--
-- Indexes for table `tb_avaliacao`
--
ALTER TABLE `tb_avaliacao`
  ADD PRIMARY KEY (`idAva`,`tb_status_idStaAva`,`tb_transporte_idTransp`),
  ADD KEY `fk_tb_avaliacao_tb_status1_idx` (`tb_status_idStaAva`),
  ADD KEY `fk_tb_avaliacao_tb_transporte1_idx` (`tb_transporte_idTransp`);
...
ALTER TABLE `tb_boleto`
  ...
  ADD KEY `fk_tb_boleto_tb_mensalidade1_idx` (`idMensa`);
...
ALTER TABLE `tb_cidade`
  ...
  ADD KEY `fk_tb_cidade_tb_estado1_idx` (`tb_Estado_idEst`);

--
-- Indexes for table `tb_conteudo_transporte`
--
ALTER TABLE `tb_conteudo_transporte`
  ADD PRIMARY KEY (`idConTran`),
  ADD KEY `fk_tb_conteudo_transporte_tb_item1_idx` (`tb_item_idItem`),
  ADD KEY `fk_tb_conteudo_transporte_tb_transporte1_idx` (`tb_transporte_idTransp`);
...
ALTER TABLE `tb_endereco`
  ...
  ADD KEY `fk_tb_endereco_tb_cidade1_idx` (`tb_cidade_idCid`),
  ADD KEY `fk_tb_endereco_tb_estado1_idx` (`tb_estado_idEst`);

--
-- Indexes for table `tb_endereco_transporte`
--
ALTER TABLE `tb_endereco_transporte`
  ADD PRIMARY KEY (`idEndTran`),
  ADD KEY `fk_tb_endereco_transporte_tb_cidade1_idx` (`tb_cidadeOrigem_IdCid`),
  ADD KEY `fk_tb_endereco_transporte_tb_cidade2_idx` (`tb_cidadeDestino_IdCid`);
...
ALTER TABLE `tb_estado`
  ...
  ADD KEY `fk_tb_estado_tb_pais1_idx` (`tb_Pais_IdPais`);

--
-- Indexes for table `tb_imagens_transporte`
--
ALTER TABLE `tb_imagens_transporte`
  ADD PRIMARY KEY (`idImgTran`),
  ADD KEY `fk_tb_imagens_transporte_tb_transporte1_idx` (`tb_transporte_idTransp`);
...
ALTER TABLE `tb_item`
  ...
  ADD KEY `fk_tb_item_tb_categoria1_idx` (`tb_categoria_idCat`);

--
-- Indexes for table `tb_lance`
--
ALTER TABLE `tb_lance`
  ADD PRIMARY KEY (`idLan`,`tb_transporte_idTransp`,`tb_pessoa_idPes`),
  ADD KEY `fk_tb_lance_tb_transporte1_idx` (`tb_transporte_idTransp`),
  ADD KEY `fk_tb_lance_tb_pessoa1_idx` (`tb_pessoa_idPes`);
...
ALTER TABLE `tb_log`
  ...
  ADD KEY `fk_tb_log_tb_pessoa1_idx` (`tb_pessoa_idPes`);

--
-- Indexes for table `tb_mensagem`
--
ALTER TABLE `tb_mensagem`
  ADD PRIMARY KEY (`idMen`,`tb_pessoa_idPes`,`tb_lance_idLan`),
  ADD KEY `fk_tb_mensagem_tb_pessoa1_idx` (`tb_pessoa_idPes`),
  ADD KEY `fk_tb_mensagem_tb_lance1_idx` (`tb_lance_idLan`);
...
ALTER TABLE `tb_mensalidade`
  ...
  ADD KEY `fk_tb_mensalidade_tb_pessoa1_idx` (`tb_pessoa_idPes`),
  ADD KEY `fk_tb_mensalidade_tb_situacaoMensalidade1_idx` (`tb_situacaoMensalidade_idSit`);
...
--
-- Indexes for table `tb_pergunta_pesquisa`
--
ALTER TABLE `tb_pergunta_pesquisa`
...
ALTER TABLE `tb_pessoa`
  ADD PRIMARY KEY (`idPes`,`tb_perfil_idPer`,`tb_Status_idSta`),
  ADD KEY `fk_tb_pessoa_tb_perfil1_idx` (`tb_perfil_idPer`),
  ADD KEY `fk_tb_pessoa_tb_status1_idx` (`tb_Status_idSta`),
  ADD KEY `fk_tb_pessoa_tb_endereco1_idx` (`tb_endereco_idEnd`);

--
-- Indexes for table `tb_pessoa_voucher`
--
ALTER TABLE `tb_pessoa_voucher`
  ADD PRIMARY KEY (`idPesVou`,`tb_voucher_idVou`,`tb_pessoa_idPes`),
  ADD KEY `fk_tb_pessoa_voucher_tb_voucher1_idx` (`tb_voucher_idVou`),
  ADD KEY `fk_tb_pessoa_voucher_tb_pessoa1_idx` (`tb_pessoa_idPes`);

--
-- Indexes for table `tb_resposta_pesquisa`
--
ALTER TABLE `tb_resposta_pesquisa`
  ADD PRIMARY KEY (`idResPes`,`tb_pergunta_pesquisa_idPqa`,`tb_pessoa_idPes`),
  ADD KEY `fk_tb_resposta_pesquisa_tb_pergunta_pesquisa1_idx` (`tb_pergunta_pesquisa_idPqa`),
  ADD KEY `fk_tb_resposta_pesquisa_tb_pessoa1_idx` (`tb_pessoa_idPes`);

--
-- Indexes for table `tb_situacaomensalidade`
--
ALTER TABLE `tb_situacaomensalidade`
...
--
-- Indexes for table `tb_statustransp`
--
ALTER TABLE `tb_statustransp`
  ADD PRIMARY KEY (`idStaTransp`);

--
-- Indexes for table `tb_transporte`
--
ALTER TABLE `tb_transporte`
  ADD PRIMARY KEY (`idTransp`,`tb_statusTransp_idStaTransp`,`tb_categoria_idCat`,`tb_pessoa_idPes`,`tb_endereco_transporte_idEndTran`),
  ADD KEY `fk_tb_transporte_tb_statusTransp1_idx` (`tb_statusTransp_idStaTransp`),
  ADD KEY `fk_tb_transporte_tb_categoria1_idx` (`tb_categoria_idCat`),
  ADD KEY `fk_tb_transporte_tb_pessoa1_idx` (`tb_pessoa_idPes`),
  ADD KEY `fk_tb_transporte_tb_endereco_transporte1_idx` (`tb_endereco_transporte_idEndTran`);
...
--
-- AUTO_INCREMENT for table `tb_alertalance`
--
ALTER TABLE `tb_alertalance`
  MODIFY `idAleLan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tb_alertamensagem`
--
ALTER TABLE `tb_alertamensagem`
  MODIFY `idAleMen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tb_avaliacao`
--
ALTER TABLE `tb_avaliacao`
  MODIFY `idAva` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_boleto`
--
ALTER TABLE `tb_boleto`
  MODIFY `idBol` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tb_cidade`
  MODIFY `idCid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5565;
--
-- AUTO_INCREMENT for table `tb_conteudo_transporte`
--
ALTER TABLE `tb_conteudo_transporte`
  MODIFY `idConTran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tb_endereco`
--
ALTER TABLE `tb_endereco`
  MODIFY `idEnd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tb_endereco_transporte`
--
ALTER TABLE `tb_endereco_transporte`
  MODIFY `idEndTran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
--
-- AUTO_INCREMENT for table `tb_estado`
--
ALTER TABLE `tb_estado`
  MODIFY `idEst` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `tb_imagens_transporte`
--
ALTER TABLE `tb_imagens_transporte`
  MODIFY `idImgTran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT for table `tb_lance`
--
ALTER TABLE `tb_lance`
  MODIFY `idLan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `tb_mensagem`
  MODIFY `idMen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tb_mensalidade`
--
ALTER TABLE `tb_mensalidade`
  MODIFY `idMensa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `tb_pergunta_pesquisa`
--
ALTER TABLE `tb_pergunta_pesquisa`
  MODIFY `idPqa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `tb_pessoa`
--
ALTER TABLE `tb_pessoa`
  MODIFY `idPes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `tb_pessoa_voucher`
--
ALTER TABLE `tb_pessoa_voucher`
  MODIFY `idPesVou` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_resposta_pesquisa`
--
ALTER TABLE `tb_resposta_pesquisa`
  MODIFY `idResPes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tb_situacaomensalidade`
--
ALTER TABLE `tb_situacaomensalidade`
...
--
ALTER TABLE `tb_status`
  MODIFY `idSta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tb_statustransp`
--
ALTER TABLE `tb_statustransp`
  MODIFY `idStaTransp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tb_transporte`
--
ALTER TABLE `tb_transporte`
  MODIFY `idTransp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
--
-- AUTO_INCREMENT for table `tb_voucher`
--
ALTER TABLE `tb_voucher`
  MODIFY `idVou` int(11) NOT NULL AUTO_INCREMENT;
--
